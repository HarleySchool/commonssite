...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Image', fields ['short_name']
        db.create_unique(u'projects_image', ['short_name'])


    def backwards(self, orm):
        # Removing unique constraint on 'Image', fields ['short_name']
        db.delete_unique(u'projects_image', ['short_name'])
