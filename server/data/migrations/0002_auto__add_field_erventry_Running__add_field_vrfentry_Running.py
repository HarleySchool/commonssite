...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ErvEntry.Running'
        db.add_column('hvac-erv', 'Running',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, db_column='running', blank=True),
                      keep_default=False)

        # Adding field 'VrfEntry.Running'
        db.add_column('hvac-vrf', 'Running',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, db_column='running', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ErvEntry.Running'
        db.delete_column('hvac-erv', 'running')

        # Deleting field 'VrfEntry.Running'
        db.delete_column('hvac-vrf', 'running')
