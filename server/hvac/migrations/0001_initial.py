...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('hvac-erv', (
            ...
            ('Running', self.gf('django.db.models.fields.NullBooleanField')(null=True, db_column='running', blank=True)),
        ))
        db.send_create_signal(u'hvac', ['ErvEntry'])
        ...
        db.send_create_signal(u'hvac', ['VrfEntry'])
