...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ErvEntry.AirDirection'
        db.alter_column('hvac-erv', 'air direction', self.gf('django.db.models.fields.CharField')(max_length=16, db_column='air direction'))

        # Changing field 'VrfEntry.AirDirection'
        db.alter_column('hvac-vrf', 'air direction', self.gf('django.db.models.fields.CharField')(max_length=16, db_column='air direction'))

    def backwards(self, orm):

        # Changing field 'ErvEntry.AirDirection'
        db.alter_column('hvac-erv', 'air direction', self.gf('django.db.models.fields.CharField')(max_length=12, db_column='air direction'))

        # Changing field 'VrfEntry.AirDirection'
        db.alter_column('hvac-vrf', 'air direction', self.gf('django.db.models.fields.CharField')(max_length=12, db_column='air direction'))
