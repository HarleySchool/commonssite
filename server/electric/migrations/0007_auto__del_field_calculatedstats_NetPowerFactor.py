...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CalculatedStats.NetPowerFactor'
        db.delete_column(u'electric_calculatedstats', 'NetPowerFactor')


    def backwards(self, orm):
        # Adding field 'CalculatedStats.NetPowerFactor'
        db.add_column(u'electric_calculatedstats', 'NetPowerFactor',
