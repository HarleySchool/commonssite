...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CalculatedStats.GrossPowerFactorUsed'
        db.delete_column(u'electric_calculatedstats', 'GrossPowerFactorUsed')

        # Deleting field 'CalculatedStats.GrossPowerFactorProduced'
        db.delete_column(u'electric_calculatedstats', 'GrossPowerFactorProduced')


    def backwards(self, orm):
        # Adding field 'CalculatedStats.GrossPowerFactorUsed'
        db.add_column(u'electric_calculatedstats', 'GrossPowerFactorUsed',
                      self.gf('django.db.models.fields.FloatField')(null=True),
                      keep_default=False)

        # Adding field 'CalculatedStats.GrossPowerFactorProduced'
        db.add_column(u'electric_calculatedstats', 'GrossPowerFactorProduced',
                      self.gf('django.db.models.fields.FloatField')(null=True),
                      keep_default=False)
